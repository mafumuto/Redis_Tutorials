...
Task.Run(async () =>
{
    Dictionary<RedisKey, StreamPosition> positions = new Dictionary<RedisKey, StreamPosition>
    {
...
Task.Run(async () =>
{
    var tempTotals = new Dictionary<RedisKey, int> { { sensor1, 0 }, { sensor2, 0 } };

    var messageCountTotals = new Dictionary<RedisKey, int>() { { sensor1, 0 }, { sensor2, 0 } };
